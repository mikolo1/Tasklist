...
<div class="editText">
    <h4 class="diverror">
        <c:if test="${sessionScope.userExists !=null}">
        Użytkownik o takim adresie email już istnieje. Proszę podać inny adres email!
    </h4>
    </c:if>
</div>
<div class="editText">
...
<div class="formedit" style="width: 300px">
    <form method="post" action="register">
        ...
        <div class="form-group">
            <label for="login">Podaj adres email:</label>
